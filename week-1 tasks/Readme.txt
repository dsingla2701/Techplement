...
To use this project we need to use the commands. 

Ex 1: python random_password_generator.py -l 8 -u -lo -d -s
This command will generate a random password of length 8 including all the types as we have specified in the command to include uppercase, lowercase, digits and special characters.
